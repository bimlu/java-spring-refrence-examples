...
public class SampleJob {
    ...
    public Step firstChunkStep() {
        return stepBuilderFactory.get("First Chunk Step")
                .<Student, com.example.springbatch.mysql.entities.Student>chunk(3)
...
//                setDelimiter("|");
    ...
    public JpaItemWriter<com.example.springbatch.mysql.entities.Student> jpaItemWriter() {

        JpaItemWriter<com.example.springbatch.mysql.entities.Student> jpaItemWriter = new JpaItemWriter<>();
